/******************************************************************
 * @Module   	: Dio
 * @Title 	 	: DIO Post Build Configuration Source file
	...
	.Channels =
		{
			...
			[DioConf_LED1_CHANNEL_ID_INDEX] =
				{
					.Port_Num = DioConf_LED1_PORT_NUM,
					.Ch_Num = DioConf_LED1_CHANNEL_NUM,
				},

			[DioConf_LED2_CHANNEL_ID_INDEX] =
				{
